    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
	...
	ALOGE("CONGZHENG CODE %d\n", code);
    switch(code) {
        case TEST: {
    ALOGE("CONGZHENG CODE TEST %d\n", code);
    ...
    ALOGE("CONGZHENG CODE RESET %d\n", code);
        ...
        case PASSWORD: {
    ALOGE("CONGZHENG CODE PASSWORD %d\n", code);
    ...
    ALOGE("CONGZHENG CODE ZERO %d\n", code);
        ...
        case GENERATE: {
    ALOGE("CONGZHENG CODE GENERATE %d\n", code);
    ...
    ALOGE("CONGZHENG CODE VERIFY %d\n", code);
        ...
        case GET_PUBKEY: {
    ALOGE("CONGZHENG CODE GET_PUBKEY %d\n", code);
        ...
        case DEL_KEY: {
    ALOGE("CONGZHENG CODE DEL_KEY %d\n", code);
    ...
    ALOGE("CONGZHENG CODE GRANT %d\n", code);
        ...
        case UNGRANT: {
    ALOGE("CONGZHENG CODE UNGRANT %d\n", code);
        ...
        case GETMTIME: {
    ALOGE("CONGZHENG CODE GETMTIME %d\n", code);
        ...
        case DUPLICATE: {
    ALOGE("CONGZHENG CODE DUPLICATE%d\n", code);
    ...
    ALOGE("CONGZHENG CODE IS_HARDWARE_BACKED%d\n", code);
        ...
        case CLEAR_UID: {
    ALOGE("CONGZHENG CODE CLEAR_UID %d\n", code);
        ...
        default:
    ALOGE("CONGZHENG CODE DEFAULT%d\n", code);
