...
LOCAL_C_INCLUDES := external/openssl/include frameworks/native/libs/seccomp/include
...
LOCAL_MODULE_TAGS := optional
LOCAL_C_INCLUDES := $(LOCAL_PATH)/include frameworks/native/libs/seccomp/include 
